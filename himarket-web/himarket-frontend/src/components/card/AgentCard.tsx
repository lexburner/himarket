          ...
          <div className="flex flex-col gap-8 mt-[20%]">
            <div className="flex justify-end">
              <TextTooltip
                ...
                placement="r"
                style={{ boxShadow: '0px 4px 8px 0px rgba(24, 101, 255, 0.16)' }}
              >
            ...
            <div className="flex justify-start">
              <TextTooltip
                ...
                placement="l"
                style={{ boxShadow: '0px 8px 24px 0px rgba(71, 71, 235, 0.08)' }}
              >
                <div className="flex flex-col gap-2 w-full p-2">
                  <span className="text-colorPrimaryBorderHover text-xs">正在为您生成旅行计划</span>
                  <div
            ...
            <div className="absolute bottom-0 h-3/4 left-[-20%] w-[140%]">
              <div className="h-full grid grid-cols-3 grid-rows-3 gap-2 opacity-15">
                {Array.from({ length: 9 }).map((_v, i) => (
                  <div className="bg-white rounded-lg" key={i} />
                ))}
              </div>
            </div>
          </div>
